...
import { createResolution } from "@/lib/ordinance-service"
...
export default function CreateResolutionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await createResolution(resolutionData)
      toast.success("Resolution created successfully!")
      router.push("/dashboard/ordinances")
    } catch (error) {
      console.error("Error creating resolution:", error)
      toast.error("Failed to create resolution. Please try again.")
    } finally {
      setLoading(false)
    }
  }
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-600">Add a new resolution to the legislative database</p>
            </div>
          </div>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="resolution_no">Resolution Number *</Label>
                    <Input
                      id="resolution_no"
                      value={formData.resolution_no}
                      onChange={(e) => handleInputChange("resolution_no", e.target.value)}
